    ...
    <div>
      ...
      <div className="album-section">
        <div className="section-up">
          ...
          <div className="play-section">
            <button
              onClick={() => playPauseTrack(sadMusic)}
              className="play-left"
            >
        ...
        <div className="section-up">
          ...
          <div className="play-section">
            <button
              onClick={() => playPauseTrack(excitingMusic)}
              className="play-left"
            >
            ...
            <div className="select-button">
              <Link to="/result/exciting">
                <button id="exciting">Select</button>
              </Link>
            </div>
          </div>
        </div>
      ...
      <div className="album-section">
        <div className="section-down">
          <img
            src={yellowAlbum}
            alt="img for yellow album"
            className="album album-yellow"
          ></img>
          <div className="song">Happy to Be Happy</div>
          <div className="singer">Danpun</div>
          <div className="play-section">
            <button
              onClick={() => playPauseTrack(happyMusic)}
              className="play-left"
            >
            ...
            <div className="select-button">
              <Link to="/result/happy">
                <button id="happy">Select</button>
              </Link>
            </div>
          </div>
        </div>
        <div className="section-down">
          <img
            src={redAlbum}
            alt="img for red album"
            className="album album-red"
          ></img>
          <div className="song">Ocean Hued</div>
          <div className="singer">Wav Two</div>
          <div className="play-section">
            <button
              onClick={() => playPauseTrack(peacefulMusic)}
              className="play-left"
            >
            ...
            <div className="select-button">
              <Link to="/result/peaceful">
                <button id="peaceful">Select</button>
              </Link>
            </div>
          </div>
        </div>
